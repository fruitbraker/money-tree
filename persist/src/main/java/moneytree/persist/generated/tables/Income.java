...
public class Income extends TableImpl<IncomeRecord> {
     ...
     */
    public final TableField<IncomeRecord, String> SOURCE = createField(DSL.name("source"), SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<IncomeRecord, String> NOTES = createField(DSL.name("notes"), SQLDataType.VARCHAR(256), this, "");
